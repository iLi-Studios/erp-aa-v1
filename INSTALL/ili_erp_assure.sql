...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `Adress_clt` varchar(250) COLLATE utf8_bin NOT NULL,
  ...
  `CreatedBy` varchar(8) COLLATE utf8_bin DEFAULT NULL,
  `CreatedDate` varchar(50) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `etablissement` (
  ...
  `Adress_ets` varchar(1000) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `etablissement` (`id_ets`, `rs_ets`, `mf_ets`, `vente_en_gros`, `rc_ets`, `activites_principale_ets`, `activites_secondaire_ets`, `Adress_ets`, `gerant_ets`, `web_ets`, `email1_ets`, `email2_ets`, `tel1_ets`, `tel2_ets`, `fax_ets`, `rib1_ets`, `rib2_ets`) VALUES
...
CREATE TABLE IF NOT EXISTS `users` (
  `idUser` varchar(8) COLLATE utf8_bin NOT NULL,
  `idRank` int(4) NOT NULL,
  `nom` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `prenom` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `email` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `FunctionPost` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `tel` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `Adress` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `BirthDay` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `Password` varchar(500) COLLATE utf8_bin DEFAULT NULL,
  `LastPasswordChangeDate` date DEFAULT NULL,
  `fbAccount` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `githubAccount` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `linkedinAccount` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `ProfilePhoto` varchar(500) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `users` (`idUser`, `idRank`, `nom`, `prenom`, `email`, `FunctionPost`, `tel`, `Adress`, `BirthDay`, `Password`, `LastPasswordChangeDate`, `fbAccount`, `githubAccount`, `linkedinAccount`, `ProfilePhoto`, `CreatedBy`, `CreatedDate`) VALUES
('08088718', 4, 'Sakly', 'Ayoub', 'sakly@ili-studios.com', 'CEO & Founder iLi-Studios SARL', '20666996', '19 Rue Ibn Zid AGBA 2010 MANOUBA TUNISIE', '22-09-1988', '3cb61b94f984497b9230075a6f777346', '0000-00-00', 'https://www.facebook.com/saklyayoub', 'https://githubAccount.com/saklyayoub', 'https://www.linkedinAccount.com/in/sakly-ayoub-ba269391', 'http://www.ili-studios.com/img/saklyayoub.png', 'Sakly Ayoub', '2015-10-28');
...
INSERT INTO `users_diploma` (`id`, `idUser`, `annee`, `lieux`, `diplome`, `etablissement`) VALUES
...
INSERT INTO `users_expirance` (`id`, `idUser`, `company`, `company_url`, `duration`, `experience`) VALUES
...
INSERT INTO `users_Rank` (`idRank`, `Rank`) VALUES
(1, 'Suspendue'),
(2, 'Utilisateur'),
(3, 'Admin'),
(4, 'Développeur');
...
INSERT INTO `users_skills` (`id`, `idUser`, `skills`, `pourcentage`) VALUES
(1, '08088718', 'JavaScript / Jquery / AJax', '35'),
(2, '08088718', 'githubAccount / Subvesion', '77'),
...
--
ALTER TABLE `client`
  ADD CONSTRAINT `client_ibfk_1` FOREIGN KEY (`CreatedBy`) REFERENCES `users` (`idUser`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `client_ibfk_2` FOREIGN KEY (`banned_by`) REFERENCES `users` (`idUser`) ON DELETE SET NULL;
...
ALTER TABLE `etablissement`
  ADD CONSTRAINT `etablissement_ibfk_1` FOREIGN KEY (`gerant_ets`) REFERENCES `users` (`idUser`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Contraintes pour la table `system_log`
--
ALTER TABLE `system_log`
  ADD CONSTRAINT `system_log_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `system_msg`
--
ALTER TABLE `system_msg`
  ADD CONSTRAINT `system_msg_ibfk_1` FOREIGN KEY (`user_envoie`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `system_msg_ibfk_2` FOREIGN KEY (`user_reception`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `system_msg_ibfk_3` FOREIGN KEY (`fermer_par`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `system_msg_rep`
  ...
  ADD CONSTRAINT `system_msg_rep_ibfk_2` FOREIGN KEY (`user_envoie_rep`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `system_msg_rep_ibfk_3` FOREIGN KEY (`user_reception_rep`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `system_notif`
--
ALTER TABLE `system_notif`
  ADD CONSTRAINT `system_notif_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`idRank`) REFERENCES `users_Rank` (`idRank`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `users_diploma`
--
ALTER TABLE `users_diploma`
  ADD CONSTRAINT `users_diploma_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `users_expirance`
--
ALTER TABLE `users_expirance`
  ADD CONSTRAINT `users_expirance_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `usersprivilege`
--
ALTER TABLE `usersprivilege`
  ADD CONSTRAINT ``usersprivilege`_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `users_skills`
--
ALTER TABLE `users_skills`
  ADD CONSTRAINT `users_skills_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE;
