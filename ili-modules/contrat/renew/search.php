...
function ListContractRenew(){
	...
	SELECT `insurancecontract`.`idContract`, `FirstName`, `FamilyName`, `TypeContract`, `KindContract`, MAX(`StartDate`), MAX(`EndDate`), `Amount`, `idCycle`,`client`.`idClient`
	 ...
	 WHERE `client`.`idClient`=`insurancecontract`.`idClient`
	   ...
	   `payment`.`idPayment`=`contractcycle`.`idPayment`
         AND
       `insurancecontract`.`KindContract`='Renouvelable'
	...
	while ($o=mysqli_fetch_array($result)){
		$idContract=$o[0];
		echo'
		  <tr id="tr" onclick="document.location=\''.$URL.'ili-modules/contrat/renew/renew?id='.$o[0].'\'">
			<td>'.$o[0].'</td>
			<td>'.$o[2].' '.$o[1].'</td>
			<td>'.$o[3].'</td>
			<td>'.$o[5].'</td>
...
<div id="container" class="row-fluid"> 
	...
	<div id="main-content"> 
		...
		<div class="container-fluid"> 
			...
			<div class="row-fluid">
				<div class="span12">
					<h3 class="page-title"> Contrat <small> Renouvellement</small> </h3>
					<ul class="breadcrumb">
						<li> <a href="<?php echo $URL; ?>"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
						<li><a href="search">Recherche Contrat</a><span class="divider-last">&nbsp;</span></li>
					</ul>
				</div>
			</div>
			<!-- END PAGE HEADER--> 
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <table class="table table-striped table-bordered" id="sample_1">
								...
								<tbody><?php ListContractRenew(); ?></tbody>
                        	</table>
                        </div>
                    </div>
