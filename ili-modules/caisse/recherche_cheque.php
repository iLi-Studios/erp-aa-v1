...
<div id="main-content"> 
	...
	<div class="container-fluid"> 
		...
		<div class="row-fluid">
			<div class="span12">
				<h3 class="page-title"> Caisse <small> Recherche Du Chéque</small> </h3>
				<ul class="breadcrumb">
					<li> <a href="<?php echo $URL; ?>"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
					<li><a href="recherche_paiement">Recherche Du Chéque</a><span class="divider-last">&nbsp;</span></li>
				</ul>
			</div>
		</div>
		<!-- END PAGE HEADER--> 
		 ...
		 <div class="row-fluid">
				<div class="span12"> 
					<!-- BEGIN EXAMPLE TABLE widget-->
						<div class="widget">
							<div class="widget-title"><h4><i class="icon-reorder"></i> Recherche Du Chéque</h4></div>
							<div class="widget-body">
								<div class="span12">
									<br/>
									<form action="" method="post">
										<input type="text" name="PaymentCode" required placeholder="CODE CHEQUE" style="margin-top:10px; margin-right:10px;"><button class="btn btn-success"><i class="icon-search icon-white"></i> Chercher</button></td>
									</form>
<?php
