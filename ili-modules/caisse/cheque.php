...
if(isset($_GET['id'])){
	$id=$_GET['id'];
	$o=QueryExcute("mysqli_fetch_object"," SELECT * FROM `payment` WHERE `PaymentCode`='$id';");
	if(!$o){RedirectJS('index?message=34');}
}
else{RedirectJS('index?message=34');}
?>
<!DOCTYPE html>
<?php echo $author; ?>
...
<div id="main-content"> 
	...
	<div class="container-fluid"> 
		...
		<div class="row-fluid">
			<div class="span12">
				<h3 class="page-title"> Caisse <small> Chéque</small> </h3>
				<ul class="breadcrumb">
					<li> <a href="<?php echo $URL; ?>"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
					<li><a href="cheque?id=<?php echo $id;?>">Détail du chéque</a><span class="divider-last">&nbsp;</span></li>
				</ul>
			</div>
		</div>
		<!-- END PAGE HEADER--> 
		 ...
		 <div class="row-fluid">
				<div class="span12"> 
					<!-- BEGIN EXAMPLE TABLE widget-->
						<div class="widget">
							<div class="widget-title"><h4><i class="icon-reorder"></i> Détails du chéque</h4></div>
							<div class="widget-body">
								<div class="span12">
									<table class="table table-borderless">
										<tbody>
										<tr>
											<td class="span4">#CHEQUE</td>
											<td><?php echo $id;?></td>
										</tr>
										<tr>
											<td class="span4">BANQUE</td>
										...
										<tr>
											...
											<td><?php echo '<a href="'.$URL.'ili-modules/caisse/paiement?id='.$o->idPayment.'">'.$o->idPayment.'</a>';?></td>
										</tr>
										<tr>
